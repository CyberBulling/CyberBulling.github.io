const function_value = ['0001', '0111', '0110', '1110', '1000', '1101', '1001', '0010', '1011', '0100', '0000', '0101', '0011', '1010', '1100', '1111'];
let randomString = '';
...
function checkAnswer() {
    ...
    if (!selectedValue) {
        alert("Выберите имя функции!");
        return;
    }
    if (selectedValue === randomString) {
        alert("Правильно! Это верная функция.");
    } else {
